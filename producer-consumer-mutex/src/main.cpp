...
static pthread_once_t cond_init = PTHREAD_ONCE_INIT;
static pthread_once_t cond_destroy = PTHREAD_ONCE_INIT;
static shared_queue queue;
...
int main(int argc, char* argv[]) {
    ...
    pthread_once(&cond_init, init_cond);
    ...
    pthread_once(&cond_destroy, destroy_cond);
    return EXIT_SUCCESS;
}
